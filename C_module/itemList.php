            ...
            <?php if ($value->price != "0") { ?>
              <div class="item">
                ...
                <div class="item-content">
                  ...
                  <div class="btns">
                    <a href="editItem.php?idx=<?= $value->idx ?>
                    ">수정</a>
                    <a href="delItem.php?idx=<?= $value->idx ?>
                    ">삭제</a>
                  </div>
                </div>
              </div>
            ...
            <?php if ($value->price != "0") { ?>
              <div class="item">
                ...
                <div class="item-content">
                  ...
                  <div class="btns">
                    <a href="editItem.php?idx=<?= $value->idx ?>">수정</a>
                    <a href="delItem.php?idx=<?= $value->idx ?>">삭제</a>
                  </div>
                </div>
              </div>
            <?php } else { ?>
